...
public class DoubleSubmitHelper {
	...
	public final static String SESSION_TOKEN_KEY = "office.double.submit.preventer.session.key";
	
	public final static String PARAMETER_NAME = "office.double.submit.preventer.parameter.name";
