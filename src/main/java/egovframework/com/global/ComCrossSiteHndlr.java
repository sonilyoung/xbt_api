...
public class ComCrossSiteHndlr extends BodyTagSupport {
	...
	public int doStartTag() throws JspException {
		...
		//System.out.println("ComCrossSiteFilter> ============================");
		try {
			// print value if available; otherwise, try 'default'
			if (value != null) {
				//System.out.println("ComCrossSiteFilter> =value");
				String sWriteEscapedXml = getWriteEscapedXml();
				//System.out.println("ComCrossSiteFilter sWriteEscapedXml>" + sWriteEscapedXml);
				...
				//System.out.println("ComCrossSiteFilter def> ="+def);

				// if we do have 'default', print it
				if (def != null) {
					// good 'default'
					out(pageContext, escapeXml, def);
				//System.out.println("ComCrossSiteFilter> ="+def);
				}
				return SKIP_BODY;
			}
	...
	public int doEndTag() throws JspException {
		try {
			//System.out.println("ComCrossSiteFilter ==== doEndTag");
			if (!needBody){
			...
			if (bodyContent != null && bodyContent.getString() != null){
				...
				//System.out.println("ComCrossSiteFilter> end");
				//System.out.println("ComCrossSiteFilter sWriteEscapedXml > sWriteEscapedXml");
    ...
    public static void main(String[] args) throws IOException
    {
    	...
    	ComCrossSiteHndlr.value = "TRNSMIT";

    	String sCrossSiteHndlr = ComCrossSiteHndlr.getWriteEscapedXml();
    	//System.out.println("writeEscapedXml " + ComCrossSiteHndlr.getWriteEscapedXml());
    	/*
